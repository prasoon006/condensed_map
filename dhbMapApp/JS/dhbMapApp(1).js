 ...
 require([
  ...
  const passport = {
    ...
    content: [{
      type: "fields",
      fieldInfos:[{
        fieldName: "CIVIQUE_DE",
        label: "First Civic Number" 
      }, {
        fieldName: "CIVIQUE_FI",
        label: "Last Civic Number" 
      }, {
        fieldName: "NOM_RUE",
        label: "Street Name" 
      }, {
        fieldName: "statscan_1",
        label: "Statistics Canada Housing Type"
      }, {
        fieldName: "ANNEE_CONS",
        label: "Year Built"
      }, {
        fieldName: "archetype",
        label: "Archetype" 
